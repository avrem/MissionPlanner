...
namespace MissionPlanner.ArduPilot
{
    public class AP_REPL
    {
        ...
        public void Start()
        {
            if (_mavint.doCommandInt(_mavint.MAV.sysid, _mavint.MAV.compid, (MAVLink.MAV_CMD) 42701, MAVLink.MAV_FRAME.GLOBAL_RELATIVE_ALT, 0, 0, 0, 0, 0, 0, 0))
            {
                _active = true;
        ...
        public void Stop()
        {
            _active = false;
            _timer?.Dispose();
            if (_mavint.doCommandInt(_mavint.MAV.sysid, _mavint.MAV.compid, (MAVLink.MAV_CMD) 42701, MAVLink.MAV_FRAME.GLOBAL_RELATIVE_ALT, 1, 0, 0, 0, 0, 0, 0))
            {
